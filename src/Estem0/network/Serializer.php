...
class Serializer {
    ...
    public static function getSkin(DataPacket $packet, int $protocol) : SkinData{
        ...
        return new SkinData($skinId, $skinPlayFabId, $skinResourcePatch, $skinData, $animations, $capeData, $geometryData, $geometryDataVersion ?? "1.19.30", $animationData, $capeId, $fullSkinId, $armSize, $skinColor, $personaPieces, $pieceTintColors, true, $premium ?? false, $persona ?? false, $capeOnClassic ?? false, $isPrimaryUser ?? true);
    }
    ...
    public static function getItemStack(DataPacket $packet, \Closure $readExtraCrapInTheMiddle, int $protocol) : Item{
        ...
        $null = null;
        [$id, $meta] = MultiProtocolItemTranslator::getInstance()->fromNetworkId($netId, $netData, $null, $protocol);
