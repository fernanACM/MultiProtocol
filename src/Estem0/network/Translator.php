            ...
            case LevelSoundEventPacket::NETWORK_ID:
                ...
                switch($packet->sound) {
                    ...
                    case LevelSoundEventPacket::SOUND_BREAK_BLOCK:
                        $block = MultiProtocolRuntimeBlockMapping::fromStaticRuntimeId($packet->extraData, $protocol);
            ...
            case LevelEventPacket::NETWORK_ID:
                ...
                switch($packet->evid) {
                    case LevelEventPacket::EVENT_PARTICLE_DESTROY:
                        ...
                        $packet->data = MultiProtocolRuntimeBlockMapping::toStaticRuntimeId($block[0], $block[1], $protocol);
                        return $packet;
                    case LevelEventPacket::EVENT_PARTICLE_PUNCH_BLOCK:
                        ...
                        $packet->data = MultiProtocolRuntimeBlockMapping::toStaticRuntimeId($block->getId(), $block->getDamage(), $protocol) | $face;
                        return $packet;
                }
                return $packet;
